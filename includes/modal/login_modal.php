                  ...
                  <div class="modal-body">
                      ...
                      <!-- Email Address -->
                       <div class="form-group">
                        ...
                        <input type="email" name="loginemail" class="form-control" id="loginemail" placeholder="Email" maxlength="30" required>
                      ...
                      <!-- Password -->   
                       <div class="form-group">
                        ...
                        <input type="password" name="loginpassword" class="form-control" id="loginpassword" placeholder="Password" maxlength="30" required>
